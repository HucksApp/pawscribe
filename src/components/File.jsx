...
const File = ({ file, setStateChange, stateChanged, handleOpenFile }) => {
  console.log(file, '-------------->>>>>>>>>>>>>>>>>>>>>');
  ...
  const handleYes = async () => {
    try {
      const response = await axios.delete(
        `${base}/Api/v1/folders/${file.fx.id}/exclude`,
        {
  ...
  return (
    ...
    >
        ...
        >
          ...
          <div className="filename">
            ...
            <div className="filetitle fname">
              {file.fx.name ? file.fx.name : file.filename}
            </div>{' '}
          </div>
          <div className="filename">
            {' '}
          ...
          <div className="filename">
            ...
            <div className="filevalue">
              {file && file.shared_with_key ? file.shared_with_key : 'None'}
            </div>
          </div>
      ...
      <AlertDialog
        title={'Alert'}
        message={`Remove ${file.filename} completely from This Folder ?`}
        handleYes={handleYes}
        handleNo={handleNo}
        open={dialogOpen}
