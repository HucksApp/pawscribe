...
const Text = ({ text, setStateChange, stateChanged, handleOpenScript }) => {
  ...
  return (
    ...
    >
      <div
        title={text.fx.name ? text.fx.name : text.file_type}
        className="card"
      >
        <CardContent
          sx={{
        ...
        >
          ...
          <div className="filename">
            ...
            <div className="filetitle fname">
              {text.fx.name ? text.fx.name : text.file_type}
            </div>{' '}
          </div>
          <div className="filename">
            {' '}
            <div className="filetitle">Type:</div>{' '}
            <div className="filevalue">Script/Texts</div>
          </div>
          <div className="filename">
            {' '}
            <div className="filetitle">Created:</div>{' '}
            <div className="filevalue">{text.created_at}</div>
          </div>
          <div className="filename">
            {' '}
            <div className="filetitle">Last updated:</div>{' '}
            <div className="filevalue">{text.updated_at}</div>
          </div>
          <div className="filename">
            {' '}
            <div className="filetitle">Acess</div>{' '}
            <div className="filevalue">
              {text && text.private ? 'Private' : 'Public'}
            </div>
          </div>
          <div className="filename">
            {' '}
            <div className="filetitle">Share With Key</div>{' '}
            <div className="filevalue">
              {text && text.shared_with_key ? text.shared_with_key : 'None'}
            </div>
          </div>
          <p
